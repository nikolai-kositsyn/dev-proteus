...
typedef enum ProteusCommandE
{
	...
	// UART
	PROTEUS_CMD_UART_SET_TERMIOS = 40,
	PROTEUS_CMD_UART_GET_TERMIOS,
	PROTEUS_CMD_UART_SET_MODEM,
	PROTEUS_CMD_UART_GET_MODEM,
	PROTEUS_CMD_UART_READ,
	PROTEUS_CMD_UART_WRITE,
	PROTEUS_CMD_UART_GET_AVAILABLE_BYTES,
