""" SPI echo device emulator """

from typing import Dict, Optional
from dev_proteus.core.protocol import SpiTransfer
from dev_proteus.devices.device_base import SPIDeviceBase


class SpiEcho(SPIDeviceBase):
    ...
    def transfer(self, transfer: SpiTransfer) -> bytes:
        ...
        if transfer.tx_buf is not None:
            self.write(transfer.tx_buf)            
        
        if transfer.rx_buf is not None:
            transfer_result = self.read(transfer.len)
